    ...
    <body>
        ...
        if($data = mysqli_query($conn, $query)){
            ...
            if($count > 0){
                ...
                echo "<tr><th>No</th><th>Ad</th><th>Soyad</th><th>Telefon</th><th>E-Mail</th><th>Cinsiyet</th><th>İşlem</th></tr>";
                while($satir = mysqli_fetch_assoc($data)){
                    echo "<tr>";
                    echo "<td>".$satir['no']."</td><td>".$satir['ad']."</td><td>".$satir['soyad']."</td>";
                    echo "<td>".$satir['tel']."</td><td>".$satir['mail']."</td><td>".$satir['cinsiyet']."</td>"; 
                    echo "<td>";
